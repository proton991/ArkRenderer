...
namespace Ark
{
	ArkPipeline::ArkPipeline(ArkDevice& device,
	...
	{
		vkDestroyShaderModule(m_arkDevice.Device(), m_vertexShaderModule,
		                      nullptr);
		vkDestroyShaderModule(m_arkDevice.Device(), m_fragShaderModule,
		                      nullptr);
	                                         ...
	                                         configInfo)
	{
		...
		if (vkCreateGraphicsPipelines(m_arkDevice.Device(), VK_NULL_HANDLE, 1,
	...
	void ArkPipeline::CreateShaderModule(const std::vector<char>& code,
	                                     VkShaderModule* shaderModule)
	{
		...
		if (vkCreateShaderModule(m_arkDevice.Device(), &createInfo, nullptr,
