...
namespace Vulkan
{
  ...
  inline void GetEnumerateVector(THandle handle, void (enumerate)(THandle, uint32_t*, TValue*),
  ...
  inline void GetEnumerateVector(THandle1 handle1, THandle2 handle2,
  ...
  template <class THandle1, class THandle2, class TValue>
  inline std::vector<TValue> GetEnumerateVector(THandle1 handle1, THandle2 handle2,
                                                VkResult (enumerate)(THandle1, THandle2, uint32_t*, TValue*))
  {
    std::vector<TValue> initial;
